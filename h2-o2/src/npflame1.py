...
fig,ax=plt.subplots()
ax.set_title("Temperature Profile of H2-O2 Diffusion flame")
...
# Save the solution
	f.save('../results/h202_npflame1.xml')
...
# write the velocity, temperature, and mole fractions to a CSV file
	...
	filename='../results/1dnpflame_h2-02_ref0_'+str(grid_iterations[i])+'.csv'
